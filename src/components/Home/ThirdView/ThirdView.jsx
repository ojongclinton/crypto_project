...
import { H11,H33 } from '../GlobalStyles';
...
const whyChooseusReasons =[ 
  {title:"Professional services",body:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Malesuada at faucibus vitae libero tellus enim eros, tristique. Lorem aliquet nunc bibendum."},
      ...
      <div css={styles.reasonBox}>
          {whyChooseusReasons.map((reason,index)=>(
            <Reason elevation={3} key={index} index={index}>
              ...
              <p css={index==0?styles.FviewMore:styles.viewMore}>Learn More <span><KeyboardArrowRightIcon style={index==0?{color:'white'}:{color:'#00C0FF'}}/></span></p>
            </Reason>
          ))}
      </div>
    </div>
