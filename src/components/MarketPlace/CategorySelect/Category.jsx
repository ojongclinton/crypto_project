...
const handleCate =(category)=>{
  ...
  return (
    <div css={styles.categoryContainer}>
        ...
        <Button variant='contained' css={styles.btnStyle} onClick={()=>navigate('/Dashboard/Create-contract')}><DashboardCustomizeIcon style={{marginRight:'1vh'}}/> Create New escrow</Button>
        </div>
    </div>
  )
}
